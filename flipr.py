...
reg= RandomForestRegressor(n_estimators=250,criterion='mse',min_samples_split=5,min_samples_leaf=5,max_features='auto',max_depth=80,bootstrap=True)
reg.fit(X,y)
...
StackingSubmission1.to_csv("Submission_1.csv",index=False)
StackingSubmission2.to_csv("Submission_2.csv",index=False)
